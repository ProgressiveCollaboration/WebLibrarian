...
public class AuthorDialog extends MDialog {
	private static final long serialVersionUID = -5629030393595722902L;
	Binder<Author> pBinder = new Binder<>(Author.class);
	VerticalLayout vLayout = new VerticalLayout();

	public AuthorDialog(final Author pBean, BeanAction action, GenericCRUD.OnAction<Author> onaction) {
		super(action);
